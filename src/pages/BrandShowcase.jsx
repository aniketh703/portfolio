    ...
    <div className="mx-auto mb-20 flex w-full max-w-7xl flex-col gap-6 px-4 md:flex-row md:gap-12 md:px-8">
        ...
        <main className="flex-1 max-w-6xl">
          ...
          <section id="typography">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div><span className="font-mono text-xs text-stone-400 mb-2 block">Primary Serif</span><h3 className="text-6xl font-serif mb-4">Playfair Display</h3></div>
          ...
          <section id="stationery">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-stone-100 border border-stone-200 p-8 relative shadow-xl transform rotate-1 transition-transform hover:rotate-0">
                   ...
                   <div className="absolute bottom-8 left-8 font-mono text-[10px] text-stone-400">ANIKETH VUSTEPALLE — 2024</div>
                </div>
                <div className="space-y-4">
          ...
          <section id="honors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 <div className="order-2 md:order-1">
                    <h3 className="font-serif text-3xl mb-2">Winner — ID Card Design</h3>
