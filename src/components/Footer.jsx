  ...
  return (
    <section id="info" className="py-16 md:py-24 bg-stone-900 text-stone-100 relative overflow-hidden rounded-t-xl">
      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 md:gap-16 px-4 md:grid-cols-2 md:px-8 relative z-10">
          <div>
        <h2 style={{ fontSize: 'var(--type-display-lg)' }} className="font-serif mb-8 md:mb-10 tracking-tighter leading-[0.98]">Let's build <br/> <span className="text-stone-300 font-light italic">tomorrow.</span></h2>
        ...
        <p style={{ fontSize: 'var(--type-body-lg)' }} className="font-light leading-[1.55] max-w-xl text-stone-300 opacity-85">I build intuitive digital experiences that align user needs with business outcomes. UI/UX Designer at PanTerra Networks with expertise in React, Python, and AI-driven systems.</p>
        <div className="mt-8 md:mt-10 pt-7 md:pt-9 border-t border-stone-800 flex flex-col sm:flex-row gap-2 sm:justify-between font-sans text-xs text-stone-500 opacity-60">
