...
const Testimonials = () => {
  ...
  return (
    <section className="mx-auto mb-16 md:mb-20 flex w-full max-w-7xl flex-col gap-6 px-4 py-16 md:py-20 md:gap-12 md:px-8">
       <div className="flex flex-col md:flex-row gap-10 md:gap-16">
           ...
           <h2 className="font-serif text-3xl md:text-5xl mb-6 tracking-tight">Testimonials</h2>
            ...
            <div key={index} className="relative pl-6 md:pl-8 border-l-2 border-stone-200 hover:border-brand-orange transition-all duration-300 group rounded-lg">
                        <Quote className="absolute -left-3 -top-3 w-6 h-6 bg-white text-stone-300 p-1 rounded" />
              <blockquote className="font-serif text-xl md:text-2xl leading-relaxed mb-4 text-stone-800 opacity-85">"{item.text}"</blockquote>
