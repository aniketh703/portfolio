 ...
 * @param {string} placeholderColor - Background color while loading (default: stone-200)
...
const LazyImage = ({ 
  ...
  return (
    ...
    >
      {/* Loading placeholder */}
      {!isLoaded && !hasError && (
        <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-stone-200 via-stone-300 to-stone-200 bg-[length:200%_100%]" 
      ...
      {hasError && (
        <div className="absolute inset-0 flex items-center justify-center bg-stone-100 text-stone-400">
          <div className="text-center">
            ...
            <p className="font-mono text-xs">Image not found</p>
          </div>
        </div>
      )}
